...
VALUES ('Jan Kowalski',
       ...
       ('Anastazja Nowakowska-Długowska',
        ...
        true,
        'anastazja-nowakowska-dlugowska-17',
...
VALUES ('Ania z rodziną', 'ania-t@byom.de', 'Wyrazy współczucia dla Was wszystkich, trzymajcie się!',
        '12uwefvggh2hd2fhfgf7r72gf7g2', true, 1L),
       ('Basia z pracy', 'bigbarbi@byom.de', 'Szczerze współczuję odejścia Taty', 'd29390uohidhcuoh83823cgaukeo', true,
        1L),
       ...
       ('Siostra Kasia', 'ksix234@byom.de', 'Nie wyobrażam sobie co czujecie, trzymajcie się...',
        '43d53hfhyjtj24rd457745vyefgd', false, 3L);

INSERT INTO person
    (name, email, password)
VALUES ('Wiktor', 'admin@byom.de', '{noop}hard'),
